...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    cbdPct: 0.963,
    cbdMg: 6846,
    description: "7109 mg/30 mL · 200 mg/mL · 40 gotas/mL · 5,0 mg can./gota",
    fullLabel: "GREENLION ESSENTIAL FULL SPECTRUM — Óleo de CBD espectro completo",
    compositionLabel: "Concentração: 7109mg / 30ml (200mg/mL) — Espectro completo\nComposição: CBD 96,3% (6846mg) · CBC 1,9% (133mg) · CBDV 0,4% (29mg) · traços de THC (≤0,2%)",
    receituarioType: "Receita branca comum",
    ...
    cannabinoidJustification: "Espectro completo (CBD + CBC + CBDV + traços de THC) potencializa o efeito anti-inflamatório, analgésico e ansiolítico via efeito entourage. CBC complementa ação anti-inflamatória; CBDV auxilia em condições convulsivantes e neurológicas.",
    cannabinoids: [
